  ...
  const services = [
...

    {
      ...
      bullets: [
        ...
        "Έλεγχος & βελτιστοποίηση ασύρματου δικτύου με WiFi 6e & 7 εξοπλισμ;o",
      ],
    },
    ...
    // ✅ ΔΗΜΙΟΥΡΓΙΑ ΙΣΤΟΣΕΛΙΔΩΝ
    {
      ...
      bullets: [
        ...
        "Δημιουργία εταιρικού email",
        "Σύνδεση με Google Maps & Διαχείριση Social (Facebook, Instagram, Google Business κ.λπ.)",
        "Φιλοξενία/Domain/DNS ρυθμίσεις",
      ],
    },
